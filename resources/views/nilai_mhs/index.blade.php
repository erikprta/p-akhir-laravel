...
<div class="card-header">
    <h2 class="card-title">Daftar Mahasantri</h2><br>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ url('nilai_mhspdf') }}" class="btn btn-danger mr-2">
                <i class="fas fa-file-pdf text-white"></i> Unduh Mahasantri
            </a>
            <a class="btn btn-info" href="{{ url('nilai_mhspdf') }}" role="button">
                Export to PDF
            </a>
        ...
        <div class="table-responsive">
            ...
            {{ $ar_nilai_mhs->links() }} <!-- Ini adalah tempat untuk menampilkan link pagination -->
        </div>
    </div>
</div>
@stop
